// To parse this data:
//
//   import { Convert, GIFSearchResponse } from "./file";
//
//   const gIFSearchResponse = Convert.toGIFSearchResponse(json);
//
...
export class Convert {
    public static toGIFSearchResponse(json: string): GIFSearchResponse {
        return cast(JSON.parse(json), r("GIFSearchResponse"));
    }

    public static gIFSearchResponseToJson(value: GIFSearchResponse): string {
        return JSON.stringify(uncast(value, r("GIFSearchResponse")), null, 2);
    }
}
